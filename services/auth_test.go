...
func TestLoginWithIncorrectPassword(t *testing.T) {
	...
	if ac.Login("incorrect password", "Hash") != nil {
...
func TestLoginWithCorrectPassword(t *testing.T) {
	...
	retrievedToken := ac.Login("password", "$2a$10$F4B95tmhW6VfQ.l.mhUj6Ow3Eg5dViTiJDsFzh8VaQr9Urd70LP9W")
...
func TestLogoutStoreTimeCalculation(t *testing.T) {
	...
	ac.Logout("Signed Token") // The Logout method's calculated storetime is recorded in mockTokenStore's StoreTime field by MockTokenStore's StoreToken method
